"""Aigis Analytics template — default brand style from the Gamma advisor pitch deck.

Extracted from: Aigis-Analytics advisor pitch.pdf (Gamma export, 10 slides)

Design principles:
- Off-white / warm stone (#E7E7E3) background — NOT pure white
- Near-black (#0C0D0E) text with bold Hubot Sans headings
- Roboto Condensed body text, clean and condensed
...
- Bold uppercase section headers (e.g. "THE PROBLEM", "HOW IT WORKS")
"""
...
def template_aigis(
    ...
    """Apply Aigis Analytics template styling.
    ...
    if slide_index == 0:
        ...
        # Section label accent bar (thin, top-left — visual anchor for headings)
        _, accent_reqs = el.create_shape(
            slide_id, "RECTANGLE",
        ...
        _, rule_reqs = el.create_line(
            ...
            color=_AIGIS["line"], weight_pt=0.75,
        )
